              ...
              <div class="login-main"> 
                <form class="theme-form" method="POST" action="{{ route('admin.login.submit') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" type="email" autocomplete="email" autofocus>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group mb-0">
                    ...
                    <a href="{{ route('admin.password.request') }}" class="link" href="forget-password.html">Forgot password?</a>
                    @endif
