    ...
    <div class="card-body">
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
          ...
          <form class="form-validate" validate="validate" action="{{ route('Admin.store') }}" method="post">
           @csrf
            <div class="row">
              ...
              <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                <button type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1 waves-effect waves-float waves-light">Create</button>
