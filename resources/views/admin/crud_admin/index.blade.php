...
@section('judul_halaman', 'List Admin')
@section('content')
<div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
				    ...
				    <button class="btn btn-success" data-toggle="tooltip" title="" data-bs-original-title="btn btn-info" data-original-title="btn btn-primary active">Create</button>
                        ...
                        <thead>
						  ...
						  <th class="sorting" tabindex="0" aria-controls="example-style-4" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 600px;">Nama Admin</th>
						  <th class="sorting" tabindex="0" aria-controls="example-style-4" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 900px;">Email</th>
						  <th class="sorting" tabindex="0" aria-controls="example-style-4" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 900px;">Password</th>
