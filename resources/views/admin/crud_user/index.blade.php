	...
	<div class="card-datatable table-responsive pt-0">
		<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
			<div class="d-flex justify-content-between align-items-center header-actions mx-1 row mt-75">
				...
				<h4 style="margin-left: 5px;">List User</h4>
				</div>
					...
					<div class="dt-action-buttons text-xl-right text-lg-left text-md-right text-left d-flex align-items-center justify-content-lg-end align-items-center flex-sm-nowrap flex-wrap mr-1">
						<div class="mr-1">
							<div id="DataTables_Table_0_filter" class="dataTables_filter">
								...
								<input type="search" name="keyword" class="form-control" placeholder="Search User" autocomplete="off" aria-controls="DataTables_Table_0" {{ request('keyword') }}>
                                </form>
							</div>
						</div>
						<div class="dt-buttons btn-group flex-wrap">
						    <a href="{{ route('User.create') }}" type="button" class="btn btn-icon btn-outline-success waves-effect mt-add-1">
            ...
            <th class="control" rowspan="1" colspan="1" style="width: 0px;"><span class="ml-1">Action</span></th>
			</tr>
			</thead>
			<tbody>
			...
			<tr role="row" class="odd">
				...
				<td>
					<div class="d-flex align-items-center col-actions">
						...
						<a href="{{ route('User.edit', $d->id) }}" class="btn btn-icon btn-flat-warning waves-effect mr-1">
