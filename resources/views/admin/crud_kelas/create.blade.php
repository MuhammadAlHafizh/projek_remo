...
@section('judul_halaman', 'Create Kelas')
@section('content')
...
<div class="row">
              <div class="col-sm-8">
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form-validate" action="{{ route('Kelas.store') }}" method="post">
                    @csrf
                    {{ method_field('POST') }}
                      ...
                      <div class="row g-3 mb-3">
                        <div class="col-md-12">
                          ...
                          <input class="form-control" id="nama_kelas" type="text" name="nama_kelas" required>
                        </div>

                        <div class="col-md-12">
                          <label class="form-label" for="nama_kelas">Kompetensi</label>
                          <input class="form-control" id="nama_kelas" type="text" name="kompetensi" required>
                        </div>
                        <!--
                        <div class="col-md-3">
